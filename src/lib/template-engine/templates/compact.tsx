...
export function CompactTemplate({ data }: TemplateProps) {
    ...
    return (
        <div className="mx-auto max-w-[8.5in] bg-white p-8 font-sans text-xs text-gray-900">
            {/* Compact Header */}
            <header className="mb-4 border-b border-blue-700 pb-2">
            ...
            <div className="grid grid-cols-[2fr_1fr] gap-6">
                ...
                <div className="space-y-4">
                    ...
                    {personalInfo?.summary && (
                        <section>
                            <h2 className="mb-1 text-sm font-bold uppercase text-blue-700">Summary</h2>
                    ...
                    {experience.length > 0 && (
                        <section>
                            <h2 className="mb-2 text-sm font-bold uppercase text-blue-700">Experience</h2>
                ...
                <div className="space-y-4">
                    ...
                    {skills.length > 0 && (
                        <section>
                            <h2 className="mb-2 text-sm font-bold uppercase text-blue-700">Skills</h2>
                    ...
                    {education.length > 0 && (
                        <section>
                            <h2 className="mb-2 text-sm font-bold uppercase text-blue-700">Education</h2>
